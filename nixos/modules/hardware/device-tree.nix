...
in
{
  ...
  config = mkIf (cfg.enable) {
    ...
    assertions = let
      ...
      invalidDtsSource = s: (s.dtsFile == null) && (s.dtsText == null);
    in
    [
      {
        assertion = cfg.dtsSource == null || !(invalidDtsSource cfg.dtsSource);
        message = ''
          dtsSource needs one of dtsFile or dtsText set
        '';
      }
      {
